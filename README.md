...
- 📝 [Notion Templates](https://www.notion.com/@samirsaci) to learn concepts of supply chain and business optimisation with articles, videos and quizzes
...
- AI Agent for Sustainable Supply-Chain Network Optimisation using MCP Server with Claude AI: [Article](https://www.samirsaci.com/how-i-deployed-an-ai-agent-for-sustainable-supply-chain-optimisation/) / [Video](https://youtu.be/oJzNnHIusZs)
...
- Create GPTs to Automate Supply Chain Analytics: ([Article](https://www.samirsaci.com/create-gpts-to-automate-supply-chain-analytics/)) - ([Video Tutorial](https://youtu.be/UdJSdRECgkI?si=NRK_Y6IvvSa7wDA6))
...
- Automate PowerPoint Slides Creation with Python: ([Article]())  - ([Github Repository](https://github.com/samirsaci/automate-powerpoint)) - ([Video Tutorial](https://youtu.be/7CsAJeQeWTc))
...
- What is Business Intelligence?:  ([Article](https://www.samirsaci.com/what-is-business-intelligence/))
...
- What is Supply Chain Analytics?: ([Article](https://www.samirsaci.com/what-is-supply-chain-analytics-2/)) - ([Video Tutorial](https://youtu.be/3d7C4pShykI))
- Production Fixed Horizon Planning with Python: ([Article](https://www.samirsaci.com/production-fixed-horizon-planning-with-python/)) - ([Video Tutorial](https://youtu.be/130AKb2DejM))
- Supply Chain Process Optimisation Using Linear Programming: ([Article](https://www.samirsaci.com/supply-chain-process-optimization-using-linear-programming/))
...
#### Transportation Operations Optimisation using Python 🚚
...
#### Warehousing Operations Optimisation using Python 📦
...
#### Data & Business
- What Is Data Quality?: ([Article](https://www.samirsaci.com/what-is-data-quality/))
- What is Business Intelligence?: ([Article](https://www.samirsaci.com/what-is-business-intelligence/))
